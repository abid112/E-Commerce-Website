<?php
	...
	$sql = "SELECT * FROM computer_accessory";
	...
	while ($row = mysqli_fetch_array($result,MYSQLI_ASSOC)) {
		$storeID[] =  $row['P_CA_Code']; 
		$storeArray[] =  $row['Product_CA_Pic'];  
	}
	//echo $storeArray[1];
	...
	for($start=0;$start<$count;$start++){
		...
		echo'
				<span><a href="Product Details_cata.php?cata=5&id='.$storeID[$start].'"><img src="'.$storeArray[$start].'" 
